...
var down = document.getElementById('geeks');		
		function gfg() {
			...
			{
				down.innerHTML = "HELLO " + id_nama + " WE WISH YOU HAPPY BIRTHDAY ON " + date1;
			}
			else {
				down.innerHTML = "HELLO "+ id_nama +" KAMU HARI INI TIDAK ULANG TAHUN";
			}		
		}
